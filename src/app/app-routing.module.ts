...
const routes: Routes = [
    ...
    { path: 'club/:url', component: VueInterneClubComponent, canActivate: [AuthGuard] },
...
const routesChild: Routes = [
    ...
    { path: '', component: ModalCreateEventComponent },
...
@NgModule({
  imports: [RouterModule.forRoot(routes, {onSameUrlNavigation: 'reload'}),RouterModule.forChild(routesChild)],
  exports: [
    RouterModule,
    A11yModule,
    CdkStepperModule,
