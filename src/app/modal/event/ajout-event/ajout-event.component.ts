...
import { DateAdapter, MatAutocompleteSelectedEvent, MatChip, MatDialogRef, MAT_DIALOG_DATA } from '@angular/material';
...
export class AjoutEventComponent implements AfterViewInit {
  ...
  constructor(
      ...
      public dialogRef: MatDialogRef<AjoutEventComponent>,
